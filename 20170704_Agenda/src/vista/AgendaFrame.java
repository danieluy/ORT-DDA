 ...
 * @author docenteFI
 */
public class AgendaFrame extends javax.swing.JFrame implements VistaAgenda {
  ...
  @Override
  public void mostarTiposTelefono(ArrayList<Tipo> listaTipos) {
  ...
  public void contactoAgregado() {
    numero.setText("");
    nombre.setText("");
    this.telefonos.setListData(new ArrayList().toArray());
    nombre.requestFocus();
  }
