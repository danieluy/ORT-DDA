...
public class ListadoUsuariosWeb implements VistaListado, HttpSessionBindingListener {
  ...
  public void mostrar(Usuario actual) {
    ...
    if (actual != null)
      strUsr = actual.getNombreCompleto();
  ...
  public void logoutOtro(int pos) {
    Usuario otro = usuarios.get(pos);
    controlador.logout(otro);
  }

  @Override
  public void mostarContador(int contador) {
    enviar("contador", contador + "");
  }
