...
public class ListadoFrame extends javax.swing.JFrame
  ...
  @SuppressWarnings("unchecked")
    ...
    private void initComponents() {
        ...
        jScrollPane1.setBounds(30, 60, 440, 290);
        ...
        contador.setBounds(30, 20, 120, 30);
    ...
    private void logoutActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_logoutActionPerformed
      ...
      Usuario otro = (Usuario) lista.getSelectedValue();
      if (otro == null)
        controlador.logout();
      else
  ...
  public void mostrar(Usuario actual) {
    if (actual != null)
      ...
      setTitle("Sin usuario");
  }

  @Override
  public void mostarContador(int valor) {
    contador.setText("Logins:" + valor);
  }
